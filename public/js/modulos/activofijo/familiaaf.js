    ...
    $('#form_save_familiaaf').validate({
        rules:
        {
          ...
          familiaaf:{
           ...
           minlength:2,
           remote: {
              url: $('base').attr('href') + 'familiaaf/validar_fa',
              type: "post",
              data: {
                id_grupoaf: function() { return $( "#id_grupoaf" ).val(); },
                familiaaf: function() { return $('#familiaaf').val(); },
        ...
        messages: 
        {
          ...
          familiaaf:{ required:"Ingresar familiaaf", minlength: "Más de 2 Letras", remote: "Ya existe" }
        },
