...
function buscar_documentos(page,tis="")
{
  ...
  $.ajax({
    url: $('base').attr('href') + 'produccionreceta/buscar_documentos',
    type: 'POST',
    data: temp,
    dataType: "json",
    beforeSend: function() {
...
$(document).on('click', '.edit', function (e) {
  ...
  {
    $.ajax({
        url: $('base').attr('href') + 'produccionreceta/edit_docu',
        type: 'POST',
...
$( "#descripcion_busc" ).autocomplete({
  type:'POST',
  serviceUrl: $('base').attr('href')+"produccionreceta/autocom_articulos",
