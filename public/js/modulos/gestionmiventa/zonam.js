$( document ).ready(function() {
    ...
    $('#form_save_zonam').validate({
        ...
        messages: 
        {
          aforo_z:{ required:"Aforo requerido",number: "Ingrese un número válido"},
          id_tipozonam:{
...
function limpiarform()
{
  ...
  $('form#form_save_zonam div.form-group').each(function(indice, elemento) {
  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.code==1) {
        ...
        $('#aforo_z').val(response.data.zonam.aforo_z);
