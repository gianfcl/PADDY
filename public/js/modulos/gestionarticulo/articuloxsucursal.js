...
$(document).on('click', '.delete', function (e) {
  ...
  swal({
    ...
    if (isConfirm.value) {
      var $url = $('base').attr('href') + 'stocktotal/index/'+idarticulo+'';
      window.open($url, '_blank');
      mostrar_swalelim(idarticulo);
      /**/
    }
...
function mostrar_swalelim(idarticulo)
{
  var nomb = "Artículo";
  swal({
    title: '¿¿Realmente deseas desactivar',
    text: " este articulo en esta sucursal?? ",
    type: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#3085d6',
    cancelButtonColor: '#d33',
