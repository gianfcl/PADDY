$( document ).ready(function() {
  ...
  $('#form_save_kardexcaja').validate({
    ...
    submitHandler: function() {
      $.ajax({
        url: $('base').attr('href') + 'ingresoscaja/save_pagopendiente',
        type: 'POST',
...
function buscar_kardexcajas(page)
{
  ...
  $.ajax({
      url: $('base').attr('href') + 'ingresoscaja/buscar_ingresoscajas',
      type: 'POST',
      data: temp,
      dataType: "json",
      beforeSend: function() {
...
{  
  var temp = "page="+page;
  $.ajax({
      url: $('base').attr('href') + 'ingresoscaja/buscar_pendientes',
      type: 'POST',
      data: temp,
      dataType: "json",
      beforeSend: function() {
...
$(document).on('click', '.add_pago', function (e) {
  ...
  if(iddet>0)
  {
    ...
    {
      $.ajax({
        url: $('base').attr('href') + 'kardexcaja/save_kardexcaja',
        type: 'POST',
        data: $('#form_save_kardexcaja').serialize(),
        dataType: "json",
        beforeSend: function() {
...
$(document).on('click', '.ver_info', function (e) {
  ...
  {
    $.ajax({
      url: $('base').attr('href') + 'ingresoscaja/ver_documento',
      type: 'POST',
