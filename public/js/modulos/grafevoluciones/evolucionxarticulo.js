...
$('#grafevo').click(function(){
  $.ajax({
    url: $('base').attr('href') + 'evolucionxarticulo/generar_grafico',
    type: 'POST',
...
{
  $.ajax({
        url: $('base').attr('href') + 'evolucionxarticulo/buscar_kardexarticulo',
        type: 'POST',
        data: $('#form_busc_kardex').serialize(),
        dataType: "json",
        beforeSend: function() {
...
function buscar_articulos(page)
{
  ...
  $.ajax({
    url: $('base').attr('href') + 'evolucionxarticulo/buscar_articulos',
    type: 'POST',
    data: temp,
    dataType: "json",
    beforeSend: function() {
...
$(document).on('click', 'a.ver', function (e) {
  ...
  if(id>0 && tipo>0 && idkardex>0)
  {
    ...
    $.ajax({
      url: $('base').attr('href') + 'evolucionxarticulo/buscar_detalle',
      type: 'POST',
      data: temp,
      dataType: "json",
      beforeSend: function() {
